        ...
        <div className="w-[90%] mx-auto my-16">
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-y-12 gap-x-8">
                <div className="flex flex-col gap-y-4">
                    <h4 className="text-[22px] md:text-[26px] font-[600]">Our people & leadership</h4>
                ...
                <div className="flex flex-col gap-y-4">
                    <h4 className="text-[22px] md:text-[26px] font-[600]">Purpose, mission & values</h4>
                    <p className="text-base md:text-lg">We are defined by our people and are deeply committed to creating a diverse and inclusive culture.</p>
                ...
                <div className="flex flex-col gap-y-4">
                    <h4 className="text-[22px] md:text-[26px] font-[600]">Our aspiration</h4>
                    <p className="text-base md:text-lg">We are defined by our people and are deeply committed to creating a diverse and inclusive culture.</p>
                ...
                <div className="flex flex-col gap-y-4">
                    <h4 className="text-[22px] md:text-[26px] font-[600]">Our governance</h4>
                    <p className="text-base md:text-lg">We are defined by our people and are deeply committed to creating a diverse and inclusive culture.</p>
                    <Link href="/"  className="flex items-center gap-x-1 text-[12px] md:text-[15px] font-[600]">Learn about our governance <ArrowRight size={16} className="inline text-blue-400" /></Link>
                </div>
            </div>
        </div>
    )
