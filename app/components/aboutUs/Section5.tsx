            ...
            <div className="w-[90%] mx-auto">
                <div className="grid grid-cols-4 gap-x-8">
                    <div className="flex flex-col gap-y-4">
                        <h4 className="text-[24px] font-[600]">Our people & leadership</h4>
                    ...
                    <div className="flex flex-col gap-y-4">
                        <h4 className="text-[24px] font-[600]">Purpose, mission & values</h4>
                        <p className="text-lg">We are defined by our people and are deeply committed to creating a diverse and inclusive culture.</p>
                    ...
                    <div className="flex flex-col gap-y-4">
                        <h4 className="text-[24px] font-[600]">Our aspiration</h4>
                        <p className="text-lg">We are defined by our people and are deeply committed to creating a diverse and inclusive culture.</p>
                    ...
                    <div className="flex flex-col gap-y-4">
                        <h4 className="text-[24px] font-[600]">Our governance</h4>
                        <p className="text-lg">We are defined by our people and are deeply committed to creating a diverse and inclusive culture.</p>
